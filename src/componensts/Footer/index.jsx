...
function Footer() {
  ...
  <div className="flex-col justify-between h-11">
    ...
    <div>
    <p className='sub_company_menu lg:font-medium text-[0.8rem] sm:text-lg md:text-xl lg:text-xl text-[#00745B]'>AboutUs</p>
    <p className='sub_company_menu  lg:font-medium text-[0.8rem] sm:text-lg md:text-xl lg:text-xl text-[#00745B]'>Careers</p>
    </div>
  </div>
  <div className="flex-col justify-between h-11">
